...
export default function ImportSubscribers() {
  ...
  function downloadTemplate() {
    const csv =
      "email,country,region,city,timezone,locale,utm_source,utm_medium,utm_campaign\n" +
      "example@email.com,US,California,Los Angeles,America/Los_Angeles,en-US,newsletter,email,spring2026\n";
  ...
  return (
    <section className="rounded-lg border border-zinc-800 bg-zinc-900/70 p-4 sm:p-5">
      ...
      <p className="mt-1 text-xs text-zinc-500">
        Upload a CSV with an <code className="text-zinc-300">email</code> column. Existing subscribers are updated; new ones are created.
      </p>
